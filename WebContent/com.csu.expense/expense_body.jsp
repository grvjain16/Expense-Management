...
<head>
    ...
    <script type="text/ecmascript" src="<%=request.getContextPath()%>/Scripts/jquery/jquery-3.3.1.js"></script>
	<script type="text/ecmascript" src="<%=request.getContextPath()%>/Scripts/jquery.jqGrid-3.8.2/js/jquery-1.4.2.min.js"></script>
	<script type="text/ecmascript" src="<%=request.getContextPath()%>/Scripts/jquery.jqGrid-3.8.2/js/i18n/grid.locale-en.js"></script>
	<script type="text/ecmascript" src="<%=request.getContextPath()%>/Scripts/jquery.jqGrid-3.8.2/js/jquery.jqGrid.min.js"></script>-->
    <script type="text/ecmascript" src="../../../js/jquery.min.js"></script> 
    <script type="text/ecmascript" src="../../../js/j77"></script>
